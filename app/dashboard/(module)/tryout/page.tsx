  ...
  return (
    <div className="w-full relative text-custBlack">
      ...
      <div className="flex gap-5 mt-4 md:mt-7">
        <p onClick={() => handleTab("available")} className={`px-3 py-2 cursor-pointer rounded-md text-xs md:text-sm drop-shadow-sm
          ${activeTab == "available" ? "bg-custPrimary text-white" : "bg-white text-custBlack"}
        `}>Available</p>
        <p onClick={() => handleTab("mytryout")} className={`px-3 py-2 cursor-pointer rounded-md text-xs md:text-sm drop-shadow-sm
          ${activeTab == "mytryout" ? "bg-custPrimary text-white" : "bg-white text-custBlack"}
        `}>MyTryout</p>
      </div>
