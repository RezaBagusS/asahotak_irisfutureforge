...
const SidebarLeft = () => {
  ...
  const handleIcon = (title: string, link:string) => {
    ...
    switch (title) {
      case "Dashboard":
        return <DashboardIcon height={20} width={20} fill={pathname === link ? "white" : "black"} />
      case "Course":
        return <CourseIcon height={20} width={20} fill={pathname === link ? "white" : "black"} />
      case "Tryout":
        return <TryoutIcon height={20} width={20} fill={pathname === link ? "white" : "black"} />
      case "Setting":
        return <SettingIcon height={20} width={20} fill={pathname === link ? "white" : "black"} />
      default:
        break;
    }
  }
  ...
  return (
    <aside className="w-2/12 bg-white py-20 px-6 h-screen">
